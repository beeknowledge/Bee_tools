...
files =glob.glob('/home/bee/work/temp/org/*[jJ][pP][gG]')
path = '/home/bee/work/temp/make'
...
for fname in files: 
    ...
    with open(path + '/' + name  + '.txt', 'w') as fout:
        writer = csv.writer(fout)
        writer.writerows(annotation)
        fout.close
    cv2.imwrite(os.path.join(path , name + 'test.jpg'), img)
